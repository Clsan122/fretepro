  ...
  return <Card>
      ...
      <CardContent className="p-4 sm:p-6 pt-0 grid gap-6">
        <div className="space-y-4">
          ...
          <CNPJLookupField label="CNPJ do Remetente" onDataFetched={data => {
          setSender(data.name);
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input value={sender} onChange={e => setSender(e.target.value)} placeholder="Digite o nome do remetente" />
          ...
          <div>
            ...
            <Input value={senderCnpj} onChange={e => setSenderCnpj(e.target.value)} placeholder="Digite o CNPJ do remetente" />
          </div>
          <div>
            <Label>Endereço do Remetente</Label>
            <Input value={senderAddress} onChange={e => setSenderAddress(e.target.value)} placeholder="Digite o endereço do remetente" />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label>Cidade</Label>
              <Input value={senderCity} onChange={e => setSenderCity(e.target.value)} placeholder="Cidade" />
            </div>
            <div>
              <Label>Estado</Label>
              <Input value={senderState} onChange={e => setSenderState(e.target.value)} placeholder="UF" maxLength={2} />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <CNPJLookupField label="CNPJ do Destinatário" onDataFetched={data => {
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input value={recipient} onChange={e => setRecipient(e.target.value)} placeholder="Digite o nome do destinatário" />
          ...
          <div>
            ...
            <Input value={recipientAddress} onChange={e => setRecipientAddress(e.target.value)} placeholder="Digite o endereço do destinatário" />
          </div>
        </div>

        <div className="space-y-4">
          {createHighlightedLabel("EXPEDIDOR")}
          <CNPJLookupField label="CNPJ do Expedidor" onDataFetched={data => {
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input value={shipper} onChange={e => setShipper(e.target.value)} placeholder="Digite o nome do expedidor" />
          ...
          <div>
            ...
            <Input value={shipperAddress} onChange={e => setShipperAddress(e.target.value)} placeholder="Digite o endereço do expedidor" />
          </div>
        </div>

        <div className="space-y-4">
          {createHighlightedLabel("RECEBEDOR")}
          <CNPJLookupField label="CNPJ do Recebedor" onDataFetched={data => {
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input value={receiver} onChange={e => setReceiver(e.target.value)} placeholder="Digite o nome do recebedor" />
          ...
          <div>
            ...
            <Input value={receiverAddress} onChange={e => setReceiverAddress(e.target.value)} placeholder="Digite o endereço do recebedor" />
          </div>
        </div>
