        ...
        <div className="border-t pt-4 border-freight-100 dark:border-freight-800">
          <div className="flex justify-between items-center mb-4">
            ...
            <Button 
              ...
              variant="outline"
              size="sm"
              className="hover:bg-freight-50 dark:hover:bg-freight-900 transition-colors"
            >
          ...
          <div className="space-y-4">
            {measurements.map((measurement) => (
              <div 
                key={measurement.id} 
                className="grid grid-cols-12 gap-2 items-center bg-freight-50/30 dark:bg-freight-900/30 p-3 rounded-md"
              >
