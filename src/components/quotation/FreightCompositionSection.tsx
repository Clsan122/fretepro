      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Textarea 
            ...
            placeholder="Adicione observações relevantes para esta cotação" 
            className="min-h-[100px] transition-all focus:ring-freight-500 focus:border-freight-500"
          />
        </div>
      </CardContent>
