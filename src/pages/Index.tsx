      ...
      <header className="sticky top-0 z-50 bg-white/10 backdrop-blur-sm border-b border-freight-200/20 dark:border-freight-800/20">
        <div className="container mx-auto flex items-center justify-between py-4 px-4 sm:px-6">
          <div className="flex items-center">
            <img alt="FreteValor Logo" className="h-12 w-auto" src="/lovable-uploads/10ea4395-f21d-4b57-be3a-2f4a98153b63.png" />
          </div>
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4 sm:p-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex justify-center mb-6">
            <img alt="FreteValor Logo" className="h-32 w-auto mb-4 object-contain" src="/lovable-uploads/21c4b661-ca3c-4ae9-b37c-aae29a49b2d1.png" />
          </div>
